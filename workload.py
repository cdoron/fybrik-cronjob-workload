...
def run_workload(read_asset_name, write_asset_name, endpoints):
    ...
    request = {
        ...
        "json_schema": '{"$schema": "http://json-schema.org/draft-07/schema#", "type": "object",  "properties": {"step": { "type": ["null", "string"] }, "type": { "type": ["null", "string"] }, "amount": { "type": ["null", "string"] }, "nameOrig": { "type": ["null", "string"] }, "oldbalanceOrg": { "type": ["null", "string"] }, "newbalanceOrig": { "type": ["null", "string"] }, "nameDest": { "type": ["null", "string"] }, "oldbalanceDest": { "type": ["null", "string"] }, "newbalanceDest": { "type": ["null", "string"] }, "isFraud": { "type": ["null", "string"] }, "isFlaggedFraud": { "type": ["null", "string"] } }}',
    }
